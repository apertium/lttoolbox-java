...
echo "Make sure Java (JDK version 1.8 or newer) and ant is installed and type:"
echo "	make"
echo "	sudo make install"
echo
echo "(Mac users: First type something like export JAVA_HOME=/System/Library/Frameworks/JavaVM.framework/Versions/1.8.0/Home)"
